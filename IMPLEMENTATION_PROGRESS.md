...
- 2026-08-20 ELITE2 variant fix: `variantInfo`/`normalizeVariantStates` now treat `nolyELITE1` as the only authoritative only-精1 marker and use the presence of an `ELITE2` key in `market_price` (not price > 0) to decide the badge exists; price 0/null means 暂无报价, not 无此款. State variants rose 902 → 1117 (BOX 3.0 恢复 7 人 / 14 款，7 名干员精2 全部可点). Unit 31/31, e2e 24/24, typecheck + build green. Deployed via GitHub push (`6e4a50e`) — Cloudflare Pages auto-build; live check confirmed `aak.nslc.top/data/catalog.v2.json` at sourceHash `4790b804…` / 1117 variants, BOX 3.0 精2 enabled, and 香草/翎羽/TULIP 精2 still correctly disabled.
